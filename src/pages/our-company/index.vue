<template lang="html">
  <div class="flex flex-col gap-5 lg:p-10 p-4 w-full items-center">
    ...
    <li class="lg:text-xl text-left lg:w-3/4 w-full md:w-7/8" data-aos="fade-up">Our Core Team</li>
...
import AOS from 'aos'
import { ourCompanySubsidiaries, teamDetails } from '@/data/ourCompany'
AOS.init()
export default {
  methods: {
    goToUrl(name: string) {
  ...
  data() {
    return {
      subsidiaries: ourCompanySubsidiaries,
